      ...
      <section className="relative h-[90vh] min-h-[700px] flex items-center justify-center overflow-hidden bg-linen-100">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="space-y-8 animate-fade-in">
            <span className="inline-block text-gold-700 tracking-[0.4em] text-xs sm:text-sm uppercase font-semibold">
              Est. 2024 • İstanbul
            </span>

            <div className="space-y-2">
              <h1 className="font-serif text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-medium leading-none tracking-tight text-espresso-950">
                {TR.siteName}
              </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div className="space-y-10 lg:pl-12">
              <div className="space-y-4">
                ...
                <h2 className="font-serif text-4xl sm:text-5xl lg:text-6xl text-espresso-950 leading-tight">
                  Her Parçanın Bir <br />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-6">
            <div className="space-y-4">
              ...
              <h2 className="font-serif text-4xl sm:text-5xl text-linen-50">Aktif Müzayedeler</h2>
            </div>

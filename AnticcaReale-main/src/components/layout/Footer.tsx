    ...
    <footer className="bg-espresso-900 text-linen-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-semibold text-gold-500 mb-4 uppercase tracking-widest text-sm">Hızlı Bağlantılar</h3>
          ...
          {/* Legal */}
          <div>
            <h3 className="font-semibold text-gold-500 mb-4 uppercase tracking-widest text-sm">Bilgi</h3>
            <ul className="space-y-2">
              <li>

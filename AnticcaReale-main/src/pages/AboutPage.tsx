    ...
    <div className="min-h-screen bg-linen-50">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        ...
        <div className="prose prose-lg max-w-none prose-headings:font-serif prose-headings:text-olive-900 prose-p:text-espresso-700 prose-p:leading-relaxed">
          ...
          <section className="mb-24">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-serif text-olive-900 mb-4">Dönemler</h2>
              <p className="text-espresso-600 max-w-2xl mx-auto">Tarih boyunca farklı dönemlerden eserler</p>
              <div className="w-12 h-1 bg-gold-400 mx-auto mt-4 rounded-full" />
            </div>

            <div className="flex flex-wrap justify-center gap-3">
              {["Osmanlı", "Art Deco", "Viktorya", "Rokoko", "Barok", "Modern", "Antik", "Bizans", "Roma", "Selçuklu"].map((era, idx) => (
                <span key={idx} className="bg-olive-900 text-gold-400 rounded-full px-4 py-2 text-sm font-medium hover:bg-olive-800 transition-colors">
                  {era}
                </span>
              ))}
            </div>
